...
Mentionable that in this case, the Kernels are one dimentional in each layers instead of the 2D implementation shown in this figure from the original paper (default implementation). So, nevertheless, the total number of parameters are also different for all models
