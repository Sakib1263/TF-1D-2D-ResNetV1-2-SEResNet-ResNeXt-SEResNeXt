...
def residual_group(inputs, n_filters, n_blocks, conv=True):
    ...
    for i in range(n_blocks):
        out = residual_block(out, n_filters)
...
if __name__ == '__main__':
    ...
    Model = ResNetv2(length, width, num_channel, model_width, problem_type=problem_type, output_nums=output_nums, pooling='avg', dropout_rate=False).ResNet152()
