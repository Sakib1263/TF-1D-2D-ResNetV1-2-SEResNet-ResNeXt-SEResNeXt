...
if __name__ == '__main__':
    ...
    model_name = 'ResNeXt152'  # DenseNet Models
    ...
    cardinality = 8 # Number of branches in the Aggregated Block
    #
    Model = ResNeXt(length, num_channel, model_width, cardinality=cardinality, problem_type=problem_type, output_nums=output_nums, pooling='avg', dropout_rate=False).ResNeXt152()
